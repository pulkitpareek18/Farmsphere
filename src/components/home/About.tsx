        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-graphite mb-4">
              At Farmspherica Innovations Pvt. Ltd., we're committed to reimagining how food is grown. Our advanced hydroponics systems deliver consistent, high-quality yields while using a fraction of the resources required by traditional farming.
            </p>
