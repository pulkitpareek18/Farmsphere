      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-8 items-center">
            ...
            {/* Social icons */}
            <a href="https://www.linkedin.com/company/Farmspherica-innovations/" target="_blank" rel="noopener noreferrer" className="ml-4 text-graphite hover:text-forest-green" aria-label="LinkedIn">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path fillRule="evenodd" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" clipRule="evenodd"></path>
              </svg>
            </a>
            <a href="https://www.instagram.com/Farmsphericainnovations/" target="_blank" rel="noopener noreferrer" className="ml-2 text-graphite hover:text-forest-green" aria-label="Instagram">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <a href="https://www.youtube.com/@Farmsphericainnovations" target="_blank" rel="noopener noreferrer" className="ml-2 text-graphite hover:text-forest-green" aria-label="YouTube">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
